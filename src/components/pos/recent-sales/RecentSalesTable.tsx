...
import { Sale, PaymentMethod } from "@/shared/types";
import { RecentSaleRow } from "./RecentSaleRow";
import { RecentSaleCard } from "./RecentSaleCard";
import { useRecentSalesEdit } from "@/hooks/ui/useRecentSalesEdit";
    ...
    <div className="flex flex-col w-full min-w-0 pb-4">
      ...
      {activeEditingSale && (
        <EditSaleModal
          ...
          isOpen={true}
          onClose={cancelEdit}
          onSave={(_bs, _usd, usdPaymentRef) =>
            saveEdit(activeEditingSale, usdPaymentRef)
          }
          editValues={{
            bs: editTotalBS,
            usd: editTotalUSD,
            usdPaymentRef: editUsdPaymentRef,
          }}
          onEditChange={{
            bs: setEditTotalBS,
            usd: setEditTotalUSD,
