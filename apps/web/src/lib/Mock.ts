export const POSTRES = [
  { id: 1, name: "Red Velvet", price: 6, currency: "USD" },
  { id: 2, name: "Cheesecake", price: 6, currency: "USD" },
  { id: 3, name: "Beso de angel", price: 6, currency: "USD" },
  { id: 4, name: "Chocoquesillo", price: 6, currency: "USD" },
  { id: 5, name: "Quesillo", price: 5, currency: "USD" },
  { id: 6, name: "Pie", price: 6, currency: "USD" },
  { id: 7, name: "3 Leches", price: 5, currency: "USD" },
...
export const TORTAS_COMPLETAS = [
  ...
  { id: 202, name: "Quesillo decorado 1kg", price: 20, currency: "USD" },
  ...
  { id: 218, name: "Vainifresa 2kg", price: 28, currency: "USD" },
];

export const BEBIDAS = [
  { id: 101, name: "Malta", price: 300, currency: "VES" },
  { id: 102, name: "Refresco", price: 300, currency: "VES" },
  { id: 103, name: "Agua Mineral", price: 2.5, currency: "USD" },
  { id: 104, name: "Té", price: 2.5, currency: "USD" },
  { id: 105, name: "Gatorade", price: 2.5, currency: "USD" },
];

// Estructura Agrupada para el Modal
export const ALL_PRODUCTS = [
  { label: "Postres / Raciones", options: POSTRES },
  { label: "Tortas Completas", options: TORTAS_COMPLETAS },
  { label: "Bebidas", options: BEBIDAS },
];

// Helper plano por si se necesita buscar por ID
export const ALL_PRODUCTS_FLAT = [...POSTRES, ...TORTAS_COMPLETAS, ...BEBIDAS];
